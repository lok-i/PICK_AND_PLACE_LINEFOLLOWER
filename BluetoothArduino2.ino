...
void lineFoll()
{
  ...
  {
    case 101:
    {stp();digitalWrite(led2,HIGH);delay(5000);digitalWrite(led2,LOW);trans=0;break;}
    case 111:
    {f();digitalWrite(led2,LOW);break;}
    case 10:
    {f();digitalWrite(led2,LOW);break;}
    case 100:
    {lftF();digitalWrite(led2,LOW);break;}
    case 110:
    {lft();digitalWrite(led2,LOW);break;}
    case 11:
    {rgt();digitalWrite(led2,LOW);break;}
    case 1:
    {rgtF();digitalWrite(led2,LOW);break;}
    default:
    {stp();digitalWrite(led2,LOW);break;}
  }
...
void Blue()
{
  if(Serial.available()>0)
  {
    ...
    switch (data)
    {
        ...
        case 'W':
        {trans=1; digitalWrite(led1,HIGH); delay(2000); digitalWrite(led1, LOW);break;}
